...
import { Create, Get, Del } from "../useCases/Groups/Controller/group.controller";
...
groupsrouter.delete('/',[TokenMiddleware, limiter(10,60000), PermissionMiddleware("ADMIN"), ValidateMiddleware(CreateGroupSchema)], Del);